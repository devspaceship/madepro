...
fn sarsa_q_learning<'s, 'a, M>(
    mdp: &M,
    config: &Config,
    q_learning: bool,
) -> ActionValue<'s, 'a, M::State, M::Action>
where
    M: MDP,
{
...
pub fn sarsa<'s, 'a, M>(mdp: &M, config: &Config) -> ActionValue<'s, 'a, M::State, M::Action>
where
    M: MDP,
{
...
pub fn q_learning<'s, 'a, M>(mdp: &M, config: &Config) -> ActionValue<'s, 'a, M::State, M::Action>
where
    M: MDP,
{
